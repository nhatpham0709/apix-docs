    ...
    <Layout description={siteConfig.tagline}>
      <div className='homepage'>
          ...
          <div className='about__cards'>
            ...
            >
              <div className='about__section'>
                ...
                <h3 className='about__header'>What is APIX?</h3>
            ...
            <Link to='learn/iota-token/buying-iota' className='about__card'>
              <div className='about__section'>
                ...
                <h3 className='about__header'>Get APIX tokens</h3>
                <p className='about__description'>
                  The APIX token is used to transact value on the APIX
                  distributed ledger.
                </p>
              </div>
            </Link>
            <Link to='/use/wallets/what-is-a-wallet' className='about__card'>
              <div className='about__section'>
                ...
                <p className='about__description'>
                  ...
                  interact with the APIX network.
                </p>
              </div>
            </Link>
          </div>
        ...
        <HomepageSection
          ...
          description='With the APIX core libraries you can easily integrate APIX into your own applications.'
        >
          <CoreLibrariesSection />
        </HomepageSection>
        <HomepageSection
          header='Application Libraries'
          description='With the APIX application libraries you can easily integrate APIX into your own applications.'
        >
          <AppLibrariesSection />
        </HomepageSection>
        <HomepageSection
          header='Nodes and extensions'
          description='Nodes are the core of an APIX network. They run the node software, which gives them read and write access to the APIX network. You can extend their functionality with additional extensions such as INX plugins or the Wasp software for Smart Contracts'
        >
          ...
          <div className='resources__cards'>
            ...
            <Link to='tutorials' className='resources__card'>
              ...
              <p className='resources__description'>
                Now that you understand the basics of APIX, it’s time to start
                your own project!
              </p>
            </Link>
            <Link to='integration-services/welcome' className='resources__card'>
              ...
              <p className='resources__description'>
                Speed up integration with APIX tools & solutions
              </p>
            </Link>
          </div>
        </HomepageSection>
          ...
          <div className='further__cards'>
            <Link to='https://discord.iota.org/' className='further__card'>
              <div className='further__section'>
                ...
                <p className='further__description'>
                  Check out the APIX community on Discord.
                </p>
              </div>
            </Link>
            ...
            >
              <div className='further__section'>
                ...
                <p className='further__description'>
                  View transactions and data stored on the APIX Tangle.
                </p>
              </div>
            </Link>
          </div>
