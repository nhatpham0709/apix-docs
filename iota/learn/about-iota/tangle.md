...
id: tangle
title: The Tangle
description: The Tangle is the data structure behind APIX that contains all information about token ownership.
...
APIX nodes currently reach consensus on the ledger state with the help of milestone blocks (also called 'milestones'). Milestones are issued by a central node called the [Coordinator](./coordinator.md). The Coordinator represents a temporary solution and will be eliminated as part of APIX's decentralization efforts.
